...
- PREÇO = INTENÇÃO CLARA: pergunta explícita de valor/preço/quanto custa/disponibilidade de QUALQUER produto — mesmo produto que você não reconhece do catálogo (ex.: botas texanas) — classifica [SETOR: ECOMMERCE]; o time de lá responde ou redireciona. Exceção: se há sinais claros de personalização (quantidade, logo, uniforme, empresa/equipe), classifique RECEPTIVO. Não confunda com MENÇÃO de produto sem pedido de preço (essa segue a regra de ambiguidade).
