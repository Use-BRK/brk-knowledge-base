...
### Resposta padrão para perguntas sobre marketplaces
A BRK possui lojas oficiais no Mercado Livre, Shopee e Amazon.
Se o cliente perguntar sobre compra em marketplace:
"Sim! Temos lojas oficiais no Mercado Livre, Shopee e Amazon. [LINKS A ADICIONAR]"

### Suporte para compras em marketplaces
Classificar como SAC — o atendimento segue o fluxo normal de suporte.
